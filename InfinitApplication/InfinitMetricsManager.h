...
typedef enum __InfinitMetricType
{
  ...
  INFINIT_METRIC_DESKTOP_NOTIFICATION_ACCEPT,
  ...
  // Quota popups.
  INFINIT_METRIC_GHOST_QUOTA_CANCEL,
  INFINIT_METRIC_GHOST_QUOTA_UPGRADE,
  INFINIT_METRIC_LINK_QUOTA_CANCEL,
  INFINIT_METRIC_LINK_QUOTA_INVITE,
  INFINIT_METRIC_LINK_QUOTA_UPGRADE,
  INFINIT_METRIC_SELF_QUOTA_CANCEL,
  INFINIT_METRIC_SELF_QUOTA_INVITE,
  INFINIT_METRIC_SELF_QUOTA_UPGRADE,
  INFINIT_METRIC_TRANSFER_QUOTA_CANCEL,
  INFINIT_METRIC_TRANSFER_QUOTA_INVITE,
  INFINIT_METRIC_TRANSFER_QUOTA_UPGRADE,
}
InfinitMetricType;
