...
ELLE_LOG_COMPONENT("OSX.OldSearchController");

@implementation OldInfinitSearchController
{
@private
  // WORKAROUND: 10.7 doesn't allow weak references to certain classes (like NSViewController)
  __unsafe_unretained id<OldInfinitSearchControllerProtocol> _delegate;
