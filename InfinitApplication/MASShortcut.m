...
{
    return [[MASShortcut alloc] initWithKeyCode:code modifierFlags:flags];
}

+ (instancetype)shortcutWithEvent:(NSEvent *)event
{
    return [[MASShortcut alloc] initWithKeyCode:event.keyCode modifierFlags:event.modifierFlags];
}
